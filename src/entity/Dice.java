...
public class Dice extends Entity{
    ...
    public void getDiceImage(){
        try{
            img[0] = ImageIO.read(getClass().getResourceAsStream("/Dices/black.png"));
            img[1] = ImageIO.read(getClass().getResourceAsStream("/Dices/blue.png"));
            img[2] = ImageIO.read(getClass().getResourceAsStream("/Dices/yellow.png"));
            img[3] = ImageIO.read(getClass().getResourceAsStream("/Dices/green.png"));
            img[4] = ImageIO.read(getClass().getResourceAsStream("/Dices/red.png"));
            img[5] = ImageIO.read(getClass().getResourceAsStream("/Dices/boat.png"));
